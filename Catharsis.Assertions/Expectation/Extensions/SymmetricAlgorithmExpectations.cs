...
{
  /// <summary>
  ///   <para>Expects that a given <see cref="SymmetricAlgorithm"/> has a specified block size in bits of cryptographic operations.</para>
  /// </summary>
  ...
  /// <summary>
  ///   <para>Expects that a given <see cref="SymmetricAlgorithm"/> has a specified size in bits of the secret key.</para>
  /// </summary>
  /// <param name="expectation">Expectation to be fulfilled.</param>
