...
{
  /// <summary>
  ///   <para>This function asserts that the given task has a specified status.</para>
  /// </summary>
  ...
  /// <summary>
  ///   <para>This function asserts that the given task completed successfully.</para>
  /// </summary>
  /// <param name="assertion">Assertion to validate.</param>
  /// <param name="task">Task to inspect.</param>
  /// <param name="error">Error message for a failed <paramref name="assertion"/>.</param>
  ...
  /// <summary>
  ///   <para>This function asserts that the given task completed unsuccessfully due to unhandled exception.</para>
  /// </summary>
  /// <param name="assertion">Assertion to validate.</param>
  /// <param name="task">Task to inspect.</param>
  /// <param name="error">Error message for a failed <paramref name="assertion"/>.</param>
  ...
  /// <summary>
  ///   <para>This function asserts that the given task failed to complete due to being cancelled.</para>
  /// </summary>
  /// <param name="assertion">Assertion to validate.</param>
  /// <param name="task">Task to inspect.</param>
  /// <param name="error">Error message for a failed <paramref name="assertion"/>.</param>
  ...
  /// <summary>
  ///   <para>This function asserts that the given task completed, whether successfully or not.</para>
  /// </summary>
  /// <param name="assertion">Assertion to validate.</param>
  /// <param name="task">Task to inspect.</param>
  /// <param name="error">Error message for a failed <paramref name="assertion"/>.</param>
  ...
  /// <summary>
  ///   <para>This function asserts that the given task ended prematurely due to specified exception.</para>
  /// </summary>
