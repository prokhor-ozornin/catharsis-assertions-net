...
{
  /// <summary>
  ///   <para>This function asserts that the given type's method is <see langword="abstract"/>.</para>
  /// </summary>
  ...
  /// <summary>
  ///   <para>This function asserts that the given type's method is <see langword="static"/>.</para>
  /// </summary>
  /// <param name="assertion">Assertion to validate.</param>
  /// <param name="method">Type's method to inspect.</param>
  /// <param name="error">Error message for a failed <paramref name="assertion"/>.</param>
  ...
  /// <summary>
  ///   <para>This function asserts that the given type's method is <see langword="final"/>.</para>
  /// </summary>
  /// <param name="assertion">Assertion to validate.</param>
  /// <param name="method">Type's method to inspect.</param>
  /// <param name="error">Error message for a failed <paramref name="assertion"/>.</param>
  ...
  /// <summary>
  ///   <para>This function asserts that the given type's method is <see langword="virtual"/>.</para>
  /// </summary>
  /// <param name="assertion">Assertion to validate.</param>
  /// <param name="method">Type's method to inspect.</param>
  /// <param name="error">Error message for a failed <paramref name="assertion"/>.</param>
  ...
  /// <summary>
  ///   <para>This function asserts that the given type's method can be overriden in subclasses.</para>
  /// </summary>
  /// <param name="assertion">Assertion to validate.</param>
  /// <param name="method">Type's method to inspect.</param>
  /// <param name="error">Error message for a failed <paramref name="assertion"/>.</param>
  ...
  /// <summary>
  ///   <para>This function asserts that the given type's method is of <see langword="private"/> visibility.</para>
  /// </summary>
  /// <param name="assertion">Assertion to validate.</param>
  /// <param name="method">Type's method to inspect.</param>
  /// <param name="error">Error message for a failed <paramref name="assertion"/>.</param>
  ...
  /// <summary>
  ///   <para>This function asserts that the given type's method is of <see langword="protected"/> visibility.</para>
  /// </summary>
  /// <param name="assertion">Assertion to validate.</param>
  /// <param name="method">Type's method to inspect.</param>
  /// <param name="error">Error message for a failed <paramref name="assertion"/>.</param>
  ...
  /// <summary>
  ///   <para>This function asserts that the given type's method is of <see langword="public"/> visibility.</para>
  /// </summary>
  /// <param name="assertion">Assertion to validate.</param>
  /// <param name="method">Type's method to inspect.</param>
  /// <param name="error">Error message for a failed <paramref name="assertion"/>.</param>
  ...
  /// <summary>
  ///   <para>This function asserts that the given type's method is of <see langword="internal"/> visibility.</para>
  /// </summary>
  /// <param name="assertion">Assertion to validate.</param>
  /// <param name="method">Type's method to inspect.</param>
  /// <param name="error">Error message for a failed <paramref name="assertion"/>.</param>
  ...
  /// <summary>
  ///   <para>This function asserts that the given type's method is of <see langword="protected internal"/> visibility.</para>
  /// </summary>
  /// <param name="assertion">Assertion to validate.</param>
  /// <param name="method">Type's method to inspect.</param>
  /// <param name="error">Error message for a failed <paramref name="assertion"/>.</param>
