...
{
  /// <summary>
  ///   <para>This function asserts that the given XML document is empty (contains no child nodes).</para>
  /// </summary>
  ...
  /// <summary>
  ///   <para>This function asserts that the given XML document has a root element with a specified name.</para>
  /// </summary>
  /// <param name="assertion">Assertion to validate.</param>
  /// <param name="document">XML document to inspect.</param>
