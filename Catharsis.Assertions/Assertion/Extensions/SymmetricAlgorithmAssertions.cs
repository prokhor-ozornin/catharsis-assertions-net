...
{
  /// <summary>
  ///   <para>This function asserts that the given algorithm has a specified block size in bits of cryptographic operations.</para>
  /// </summary>
  ...
  /// <summary>
  ///   <para>This function asserts that the given algorithm has a specified size in bits of the secret key.</para>
  /// </summary>
  /// <param name="assertion">Assertion to validate.</param>
  /// <param name="algorithm">Cryptographic algorithm to inspect.</param>
