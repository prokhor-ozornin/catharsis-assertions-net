...
{
  /// <summary>
  ///   <para>This function asserts that the given object property can be read.</para>
  /// </summary>
  ...
  /// <summary>
  ///   <para>This function asserts that the given object property is read-only (cannot be written to).</para>
  /// </summary>
  /// <param name="assertion">Assertion to validate.</param>
  /// <param name="property">Object property to inspect.</param>
  /// <param name="error">Error message for a failed <paramref name="assertion"/>.</param>
  ...
  /// <summary>
  ///   <para>This function asserts that the given object property can be written to.</para>
  /// </summary>
  /// <param name="assertion">Assertion to validate.</param>
  /// <param name="property">Object property to inspect.</param>
  /// <param name="error">Error message for a failed <paramref name="assertion"/>.</param>
  ...
  /// <summary>
  ///   <para>This function asserts that the given object property is write-only (cannot be read).</para>
  /// </summary>
  /// <param name="assertion">Assertion to validate.</param>
  /// <param name="property">Object property to inspect.</param>
  /// <param name="error">Error message for a failed <paramref name="assertion"/>.</param>
  ...
  /// <summary>
  ///   <para>This function asserts that the given object property has a specified value.</para>
  /// </summary>
  /// <param name="assertion">Assertion to validate.</param>
  /// <param name="property">Object property to inspect.</param>
