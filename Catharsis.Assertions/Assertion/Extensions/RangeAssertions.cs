...
{
  /// <summary>
  ///   <para>This function asserts that the given range's start index has a specified value.</para>
  /// </summary>
  ...
  /// <summary>
  ///   <para>This function asserts that the given range's end index has a specified value.</para>
  /// </summary>
  /// <param name="assertion">Assertion to validate.</param>
  /// <param name="range">Range to inspect.</param>
  /// <param name="index">Asserted index value.</param>
