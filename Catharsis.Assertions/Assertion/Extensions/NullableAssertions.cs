...
{
  /// <summary>
  ///   <para>This function asserts that the given nullable object has a valid value of its underlying type.</para>
  /// </summary>
  ...
  /// <summary>
  ///   <para>This function asserts that the given nullable object has a specified value, either default or not.</para>
  /// </summary>
  /// <typeparam name="T">Underlying type of the nullable object.</typeparam>
  /// <param name="assertion">Assertion to validate.</param>
  /// <param name="instance">Nullable object instance to inspect.</param>
