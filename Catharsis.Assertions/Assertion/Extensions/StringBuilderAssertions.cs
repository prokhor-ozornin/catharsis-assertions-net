...
/// <summary>
///   <para>A set of assertions for the <see cref="StringBuilder"/> type.</para>
/// </summary>
/// <seealso cref="StringBuilder"/>
public static class StringBuilderAssertions
{
  /// <summary>
  ///   <para>Asserts that the given <see cref="StringBuilder"/> contains a specified number of characters.</para>
  /// </summary>
  ...
  /// <exception cref="ArgumentNullException">If either <paramref name="assertion"/> or <paramref name="builder"/> is <see langword="null"/>.</exception>
  ...
  /// <summary>
  ///   <para>Asserts that the given <see cref="StringBuilder"/> is empty (contains no characters).</para>
  /// </summary>
  /// <param name="assertion">Assertion to validate.</param>
  /// <param name="builder">String builder to inspect.</param>
  /// <param name="error">Error message for a failed <paramref name="assertion"/>.</param>
