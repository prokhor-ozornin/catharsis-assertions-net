...
{
  /// <summary>
  ///   <para>Asserts that the given <see cref="StringBuilder"/> has the specified length.</para>
  /// </summary>
  ...
  /// <summary>
  ///   <para>Asserts that the given <see cref="StringBuilder"/> is empty, meaning it contains no characters.</para>
  /// </summary>
  /// <param name="assertion">Assertion to validate.</param>
  /// <param name="builder">String builder to inspect.</param>
  /// <param name="error">Error message for a failed <paramref name="assertion"/>.</param>
