...
{
  /// <summary>
  ///   <para>Asserts that the given <see cref="ICollection{T}"/> has a specified number of elements.</para>
  /// </summary>
  ...
  /// <summary>
  ///   <para>Asserts that the given <see cref="ICollection{T}"/> is empty, meaning it contains no elements.</para>
  /// </summary>
  /// <typeparam name="T">The type of elements in the collection.</typeparam>
  /// <param name="assertion">Assertion to validate.</param>
  /// <param name="collection">Collection to inspect.</param>
  ...
  /// <summary>
  ///   <para>Asserts that the given <see cref="ICollection{T}"/> is read-only.</para>
  /// </summary>
  /// <typeparam name="T">The type of elements in the collection.</typeparam>
  /// <param name="assertion">Assertion to validate.</param>
  /// <param name="collection">Collection to inspect.</param>
