...
{
  /// <summary>
  ///   <para>This function asserts that the given <see cref="TimeSpan"/> has a specified days component.</para>
  /// </summary>
  ...
  /// <summary>
  ///   <para>This function asserts that the given <see cref="TimeSpan"/> has a specified hours component.</para>
  /// </summary>
  /// <param name="assertion">Assertion to validate.</param>
  /// <param name="timeSpan">Time interval to inspect.</param>
  ...
  /// <summary>
  ///   <para>This function asserts that the given <see cref="TimeSpan"/> has a specified minutes component.</para>
  /// </summary>
  /// <param name="assertion">Assertion to validate.</param>
  /// <param name="timeSpan">Time interval to inspect.</param>
  ...
  /// <summary>
  ///   <para>This function asserts that the given <see cref="TimeSpan"/> has a specified seconds component.</para>
  /// </summary>
  /// <param name="assertion">Assertion to validate.</param>
  /// <param name="timeSpan">Time interval to inspect.</param>
  ...
  /// <summary>
  ///   <para>This function asserts that the given <see cref="TimeSpan"/> has a specified milliseconds component.</para>
  /// </summary>
  /// <param name="assertion">Assertion to validate.</param>
  /// <param name="timeSpan">Time interval to inspect.</param>
  ...
  /// <summary>
  ///   <para>This function asserts that the given <see cref="TimeSpan"/> represents a specified total number of whole days.</para>
  /// </summary>
  /// <param name="assertion">Assertion to validate.</param>
  /// <param name="timeSpan">Time interval to inspect.</param>
  ...
  /// <summary>
  ///   <para>This function asserts that the given <see cref="TimeSpan"/> represents a specified total number of whole hours.</para>
  /// </summary>
  /// <param name="assertion">Assertion to validate.</param>
  /// <param name="timeSpan">Time interval to inspect.</param>
  ...
  /// <summary>
  ///   <para>This function asserts that the given <see cref="TimeSpan"/> represents a specified total number of whole minutes.</para>
  /// </summary>
  /// <param name="assertion">Assertion to validate.</param>
  /// <param name="timeSpan">Time interval to inspect.</param>
  ...
  /// <summary>
  ///   <para>This function asserts that the given <see cref="TimeSpan"/> represents a specified total number of whole seconds.</para>
  /// </summary>
  /// <param name="assertion">Assertion to validate.</param>
  /// <param name="timeSpan">Time interval to inspect.</param>
  ...
  /// <summary>
  ///   <para>This function asserts that the given <see cref="TimeSpan"/> represents a specified total number of whole milliseconds.</para>
  /// </summary>
  /// <param name="assertion">Assertion to validate.</param>
  /// <param name="timeSpan">Time interval to inspect.</param>
