...
{
  /// <summary>
  ///   <para>This function asserts that the given object's field is of the specified type.</para>
  /// </summary>
  ...
  /// <summary>
  ///   <para>This function asserts that the given object's field has <see langword="private"/> visibility.</para>
  /// </summary>
  /// <param name="assertion">Assertion to validate.</param>
  /// <param name="field">Field to inspect.</param>
  /// <param name="error">Error message for a failed <paramref name="assertion"/>.</param>
  ...
  /// <summary>
  ///   <para>This function asserts that the given object's field has <see langword="protected"/> visibility.</para>
  /// </summary>
  /// <param name="assertion">Assertion to validate.</param>
  /// <param name="field">Field to inspect.</param>
  /// <param name="error">Error message for a failed <paramref name="assertion"/>.</param>
  ...
  /// <summary>
  ///   <para>This function asserts that the given object's field has <see langword="public"/> visibility.</para>
  /// </summary>
  /// <param name="assertion">Assertion to validate.</param>
  /// <param name="field">Field to inspect.</param>
  /// <param name="error">Error message for a failed <paramref name="assertion"/>.</param>
  ...
  /// <summary>
  ///   <para>This function asserts that the given object's field has <see langword="internal"/> visibility.</para>
  /// </summary>
  /// <param name="assertion">Assertion to validate.</param>
  /// <param name="field">Field to inspect.</param>
  /// <param name="error">Error message for a failed <paramref name="assertion"/>.</param>
  ...
  /// <summary>
  ///   <para>This function asserts that the given object's field has <see langword="protected internal"/> visibility.</para>
  /// </summary>
  /// <param name="assertion">Assertion to validate.</param>
  /// <param name="field">Field to inspect.</param>
  /// <param name="error">Error message for a failed <paramref name="assertion"/>.</param>
  ...
  /// <summary>
  ///   <para>This function asserts that the given object's field is <see langword="static"/>.</para>
  /// </summary>
  /// <param name="assertion">Assertion to validate.</param>
  /// <param name="field">Field to inspect.</param>
  /// <param name="error">Error message for a failed <paramref name="assertion"/>.</param>
