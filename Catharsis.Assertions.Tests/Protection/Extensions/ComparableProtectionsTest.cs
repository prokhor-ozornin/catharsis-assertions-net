...
/// <summary>
///   <para>Tests set for class <see cref="ComparableProtections"/>.</para>
/// </summary>
public sealed class ComparableProtectionsTest : UnitTest
{
  /// <summary>
  ///   <para>Performs testing of <see cref="ComparableProtections.Positive{T}(IProtection, T, string)"/> method.</para>
  /// </summary>
  [Fact]
  public void Positive_Method()
  {
    AssertionExtensions.Should(() => ComparableProtections.Positive(null, 0)).ThrowExactly<ArgumentNullException>().WithParameterName("protection");
  ...
  /// <summary>
  ///   <para>Performs testing of <see cref="ComparableProtections.Negative{T}(IProtection, T, string)"/> method.</para>
  /// </summary>
  [Fact]
  public void Negative_Method()
  {
    AssertionExtensions.Should(() => ComparableProtections.Negative(null, 0)).ThrowExactly<ArgumentNullException>().WithParameterName("protection");
  ...
  /// <summary>
  ///   <para>Performs testing of <see cref="ComparableProtections.Zero{T}(IProtection, T, string)"/> method.</para>
  /// </summary>
  [Fact]
  public void Zero_Method()
  {
    AssertionExtensions.Should(() => ComparableProtections.Zero(null, 0)).ThrowExactly<ArgumentNullException>().WithParameterName("protection");
  ...
  ///   <list type="bullet">
  ///     <item><description><see cref="ComparableProtections.OutOfRange{T}(IProtection, T, T, T, string)"/></description></item>
  ///     <item><description><see cref="ComparableProtections.OutOfRange(IProtection, int, Range, string)"/></description></item>
  ///   </list>
  /// </summary>
  [Fact]
  public void OutOfRange_Methods()
  {
    ...
    {
      AssertionExtensions.Should(() => ComparableProtections.OutOfRange(null, 0, 0, 0)).ThrowExactly<ArgumentNullException>().WithParameterName("protection");
    ...
    using (new AssertionScope())
    {
      AssertionExtensions.Should(() => ComparableProtections.OutOfRange(null, 0, ..0)).ThrowExactly<ArgumentNullException>().WithParameterName("protection");
