...
/// <summary>
///   <para>A set of protections for the <see cref="StreamReader"/> type.</para>
/// </summary>
...
public static class StreamReaderProtections
{
  ...
  {
    /// <summary>
    ///   <para>This function protects the given <see cref="StreamReader"/> from being empty, ensuring that it has a non-empty underlying <see cref="Stream"/>.</para>
    /// </summary>
    ...
    public StreamReader Empty(StreamReader reader, string error = null)
    {
