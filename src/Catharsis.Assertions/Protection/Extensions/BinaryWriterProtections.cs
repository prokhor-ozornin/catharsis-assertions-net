...
/// <summary>
///   <para>A set of protections for the <see cref="BinaryWriter"/> type.</para>
/// </summary>
/// <seealso cref="BinaryWriter"/>
public static class BinaryWriterProtections
{
  /// <summary>
  ///   <para>This function protects the given <see cref="BinaryWriter"/> from being empty, ensuring that it has a non-empty underlying <see cref="Stream"/>.</para>
  /// </summary>
