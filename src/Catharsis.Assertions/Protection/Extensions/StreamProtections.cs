...
/// <summary>
///   <para>A set of protections for the <see cref="Stream"/> type.</para>
/// </summary>
/// <seealso cref="Stream"/>
public static class StreamProtections
{
  ...
  {
    /// <summary>
    ///   <para>This function protects the given <see cref="Stream"/> from being empty, ensuring that its size is not zero.</para>
    /// </summary>
    ...
    public TStream Empty<TStream>(TStream stream, string error = null) where TStream : Stream
    {
