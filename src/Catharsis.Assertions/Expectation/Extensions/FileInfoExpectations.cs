...
/// <summary>
///   <para>A set of expectations for the <see cref="FileInfo"/> type.</para>
/// </summary>
/// <seealso cref="FileInfo"/>
public static class FileInfoExpectations
{
  /// <summary>
  ///   <para>Expects that the given <see cref="FileInfo"/> is of a specified size.</para>
  /// </summary>
  ...
  /// <summary>
  ///   <para>Expects that the given <see cref="FileInfo"/> is empty.</para>
  /// </summary>
  /// <param name="expectation">Expectation to be fulfilled.</param>
  /// <returns>Back self-reference to the given <paramref name="expectation"/>.</returns>
  /// <exception cref="ArgumentNullException">If the <paramref name="expectation"/> is either a <see langword="null"/> or has an undefined subject.</exception>
  ...
  /// <summary>
  ///   <para>Expects that the given <see cref="FileInfo"/> is read-only.</para>
  /// </summary>
  /// <param name="expectation">Expectation to be fulfilled.</param>
  /// <returns>Back self-reference to the given <paramref name="expectation"/>.</returns>
  /// <exception cref="ArgumentNullException">If the <paramref name="expectation"/> is either a <see langword="null"/> or has an undefined subject.</exception>
  ...
  /// <summary>
  ///   <para>Expects that the given <see cref="FileInfo"/> is located in the given directory.</para>
  /// </summary>
  /// <param name="expectation">Expectation to be fulfilled.</param>
  /// <param name="directory">Expected file location directory.</param>
  /// <returns>Back self-reference to the given <paramref name="expectation"/>.</returns>
  /// <exception cref="ArgumentNullException">If the <paramref name="expectation"/> is either a <see langword="null"/> or has an undefined subject, or <paramref name="directory"/> is <see langword="null"/>.</exception>
