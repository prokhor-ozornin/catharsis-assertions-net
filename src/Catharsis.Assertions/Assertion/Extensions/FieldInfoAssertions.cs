...
public static class FieldInfoAssertions
{
  ...
  extension(IAssertion assertion)
  {
    ...
    public IAssertion Type(FieldInfo field, Type type, string error = null)
    {
    ...
    public IAssertion Type<T>(FieldInfo field, string error = null) => assertion.Type(field, typeof(T), error);
    ...
    /// <exception cref="ArgumentNullException">If either <paramref name="assertion"/> or <paramref name="field"/> is <see langword="null"/>.</exception>
    /// <exception cref="InvalidOperationException">If the given <paramref name="assertion"/> is invalid.</exception>
    public IAssertion Private(FieldInfo field, string error = null) => field is not null ? assertion.True(field.IsPrivate, error) : throw new ArgumentNullException(nameof(field));
    ...
    /// <exception cref="ArgumentNullException">If either <paramref name="assertion"/> or <paramref name="field"/> is <see langword="null"/>.</exception>
    /// <exception cref="InvalidOperationException">If the given <paramref name="assertion"/> is invalid.</exception>
    public IAssertion Protected(FieldInfo field, string error = null) => field is not null ? assertion.True(field.IsFamily, error) : throw new ArgumentNullException(nameof(field));
    ...
    /// <exception cref="ArgumentNullException">If either <paramref name="assertion"/> or <paramref name="field"/> is <see langword="null"/>.</exception>
    /// <exception cref="InvalidOperationException">If the given <paramref name="assertion"/> is invalid.</exception>
    public IAssertion Public(FieldInfo field, string error = null) => field is not null ? assertion.True(field.IsPublic, error) : throw new ArgumentNullException(nameof(field));
    ...
    /// <exception cref="ArgumentNullException">If either <paramref name="assertion"/> or <paramref name="field"/> is <see langword="null"/>.</exception>
    /// <exception cref="InvalidOperationException">If the given <paramref name="assertion"/> is invalid.</exception>
    public IAssertion Internal(FieldInfo field, string error = null) => field is not null ? assertion.True(field.IsAssembly, error) : throw new ArgumentNullException(nameof(field));
    ...
    /// <exception cref="ArgumentNullException">If either <paramref name="assertion"/> or <paramref name="field"/> is <see langword="null"/>.</exception>
    /// <exception cref="InvalidOperationException">If the given <paramref name="assertion"/> is invalid.</exception>
    public IAssertion ProtectedInternal(FieldInfo field, string error = null) => field is not null ? assertion.True(field.IsFamilyOrAssembly, error) : throw new ArgumentNullException(nameof(field));
    ...
    /// <exception cref="ArgumentNullException">If either <paramref name="assertion"/> or <paramref name="field"/> is <see langword="null"/>.</exception>
    /// <exception cref="InvalidOperationException">If the given <paramref name="assertion"/> is invalid.</exception>
    public IAssertion Static(FieldInfo field, string error = null) => field is not null ? assertion.True(field.IsStatic, error) : throw new ArgumentNullException(nameof(field));
    ...
    /// <exception cref="ArgumentNullException">If either <paramref name="assertion"/> or <paramref name="field"/> is <see langword="null"/>.</exception>
    /// <exception cref="InvalidOperationException">If the given <paramref name="assertion"/> is invalid.</exception>
    public IAssertion Value(FieldInfo field, object subject, object value, string error = null)
    {
      if (assertion is null) throw new ArgumentNullException(nameof(assertion));
      if (field is null) throw new ArgumentNullException(nameof(field));
