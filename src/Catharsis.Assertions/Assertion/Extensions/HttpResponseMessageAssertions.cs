...
{
  /// <summary>
  ///   <para>Asserts that the given <see cref="HttpResponseMessage"/> was successful.</para>
  /// </summary>
  ...
  /// <summary>
  ///   <para>Asserts that the given <see cref="HttpResponseMessage"/> has the specified result status code.</para>
  /// </summary>
  /// <param name="assertion">Assertion to validate.</param>
  /// <param name="response">HTTP response to inspect.</param>
  ...
  /// <summary>
  ///   <para>Asserts that the given <see cref="HttpResponseMessage"/> contains a header with the specified name and value.</para>
  /// </summary>
  /// <param name="assertion">Assertion to validate.</param>
  /// <param name="response">HTTP response to inspect.</param>
  ...
  public static IAssertion Header(this IAssertion assertion, HttpResponseMessage response, string name, string value, string error = null)
  {
    ...
    return assertion.Contain(response.Headers.Contains(name) ? response.Headers.GetValues(name) : [], value, null, error);
  }
}