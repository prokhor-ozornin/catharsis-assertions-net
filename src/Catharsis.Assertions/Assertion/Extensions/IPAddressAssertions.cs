...
public static class IPAddressAssertions
{
  ...
  extension(IAssertion assertion)
  {
    ...
    public IAssertion Ip4(IPAddress address, string error = null) => address is not null ? assertion.True(address.AddressFamily == AddressFamily.InterNetwork, error) : throw new ArgumentNullException(nameof(address));
    ...
    public IAssertion Ip6(IPAddress address, string error = null) => address is not null ? assertion.True(address.AddressFamily == AddressFamily.InterNetworkV6, error) : throw new ArgumentNullException(nameof(address));
  }
}