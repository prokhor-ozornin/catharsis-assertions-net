...
public static class DateTimeAssertions
{
  ...
  extension(IAssertion assertion)
  {
    ...
    public IAssertion Past(DateTime date, string error = null) => assertion.True(date.ToUniversalTime() < DateTime.UtcNow, error);
    ...
    public IAssertion Future(DateTime date, string error = null) => assertion.True(date.ToUniversalTime() > DateTime.UtcNow, error);
    ...
    /// <exception cref="ArgumentNullException">If <paramref name="assertion"/> is <see langword="null"/>.</exception>
    /// <exception cref="InvalidOperationException">If the given <paramref name="assertion"/> is invalid.</exception>
    public IAssertion DayOfYear(DateTime date, int day, string error = null) => assertion.True(date.DayOfYear == day, error);
    ...
    /// <exception cref="ArgumentNullException">If <paramref name="assertion"/> is <see langword="null"/>.</exception>
    /// <exception cref="InvalidOperationException">If the given <paramref name="assertion"/> is invalid.</exception>
    public IAssertion Year(DateTime date, int year, string error = null) => assertion.True(date.Year == year, error);
    ...
    /// <exception cref="ArgumentNullException">If <paramref name="assertion"/> is <see langword="null"/>.</exception>
    /// <exception cref="InvalidOperationException">If the given <paramref name="assertion"/> is invalid.</exception>
    public IAssertion Month(DateTime date, int month, string error = null) => assertion.True(date.Month == month, error);
    ...
    /// <exception cref="ArgumentNullException">If <paramref name="assertion"/> is <see langword="null"/>.</exception>
    /// <exception cref="InvalidOperationException">If the given <paramref name="assertion"/> is invalid.</exception>
    public IAssertion Day(DateTime date, int day, string error = null) => assertion.True(date.Day == day, error);
    ...
    /// <exception cref="ArgumentNullException">If <paramref name="assertion"/> is <see langword="null"/>.</exception>
    /// <exception cref="InvalidOperationException">If the given <paramref name="assertion"/> is invalid.</exception>
    public IAssertion Hour(DateTime date, int hour, string error = null) => assertion.True(date.Hour == hour, error);
    ...
    /// <exception cref="ArgumentNullException">If <paramref name="assertion"/> is <see langword="null"/>.</exception>
    /// <exception cref="InvalidOperationException">If the given <paramref name="assertion"/> is invalid.</exception>
    public IAssertion Minute(DateTime date, int minute, string error = null) => assertion.True(date.Minute == minute, error);
    ...
    /// <exception cref="ArgumentNullException">If <paramref name="assertion"/> is <see langword="null"/>.</exception>
    /// <exception cref="InvalidOperationException">If the given <paramref name="assertion"/> is invalid.</exception>
    public IAssertion Second(DateTime date, int second, string error = null) => assertion.True(date.Second == second, error);
    ...
    /// <exception cref="ArgumentNullException">If <paramref name="assertion"/> is <see langword="null"/>.</exception>
    /// <exception cref="InvalidOperationException">If the given <paramref name="assertion"/> is invalid.</exception>
    public IAssertion Millisecond(DateTime date, int millisecond, string error = null) => assertion.True(date.Millisecond == millisecond, error);
    ...
    /// <exception cref="ArgumentNullException">If <paramref name="assertion"/> is <see langword="null"/>.</exception>
    /// <exception cref="InvalidOperationException">If the given <paramref name="assertion"/> is invalid.</exception>
    public IAssertion DayOfWeek(DateTime date, DayOfWeek day, string error = null) => assertion.True(date.DayOfWeek == day, error);
    ...
    public IAssertion LocalTime(DateTime date, string error = null) => assertion.True(date.Kind == DateTimeKind.Local, error);
    ...
    public IAssertion UtcTime(DateTime date, string error = null) => assertion.True(date.Kind == DateTimeKind.Utc, error);
  }
}