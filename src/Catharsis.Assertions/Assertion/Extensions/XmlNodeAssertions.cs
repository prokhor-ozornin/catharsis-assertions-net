...
public static class XmlNodeAssertions
{
  ...
  extension(IAssertion assertion)
  {
    ...
    public IAssertion Empty(XmlNode node, string error = null) => node is not null ? assertion.False(node.HasChildNodes, error) : throw new ArgumentNullException(nameof(node));
    ...
    /// <exception cref="InvalidOperationException">If the given <paramref name="assertion"/> is invalid.</exception>
    public IAssertion Name(XmlNode node, string name, string error = null)
    {
    ...
    /// <exception cref="InvalidOperationException">If the given <paramref name="assertion"/> is invalid.</exception>
    public IAssertion InnerText(XmlNode node, string text, string error = null)
    {
      if (assertion is null) throw new ArgumentNullException(nameof(assertion));
      if (node is null) throw new ArgumentNullException(nameof(node));
    ...
    public IAssertion InnerXml(XmlNode node, string xml, string error = null)
    {
      if (assertion is null) throw new ArgumentNullException(nameof(assertion));
      if (node is null) throw new ArgumentNullException(nameof(node));
    ...
    public IAssertion OuterXml(XmlNode node, string xml, string error = null)
    {
      if (assertion is null) throw new ArgumentNullException(nameof(assertion));
      if (node is null) throw new ArgumentNullException(nameof(node));
      if (xml is null) throw new ArgumentNullException(nameof(xml));
    ...
    /// <exception cref="ArgumentNullException">If either <paramref name="assertion"/> or <paramref name="node"/> is <see langword="null"/>.</exception>
    /// <exception cref="InvalidOperationException">If the given <paramref name="assertion"/> is invalid.</exception>
    public IAssertion Value(XmlNode node, string value, string error = null) => node is not null ? assertion.True(node.Value == value, error) : throw new ArgumentNullException(nameof(node));
  }
}